...
const Card = ({name, src, onClick}) => {
  return (
    <div onClick={onClick} className="max-w-sm max-sm:h-60 h-56 bg-white  rounded-lg  flex flex-col items-center ">
        
  <a href="#">
    <Image width={150} height={150} className="rounded-t-lg" src={src} alt={name} />
  </a>
  <div className="p-5">
    <a href="#">
